...
// ,
  {
    host: "smtp.zoho.in",// SMTP server address (usually mail.your-domain.com)
    port: 587, // Port for SMTP (usually 465)
    secure: false, // Usually true if connecting to port 465
    auth: {
      user: "robertcena30@zohomail.in", // Accessing email user from environment variable
      pass: "XJAGAp8gQut7", //"pudrzgdsxfturbtb", // Password (for gmail, your app password)
      // ⚠️ For better security, use environment variables set on the server for these values when deploying
    },
  }
);
